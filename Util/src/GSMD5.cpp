 ...
 */
GSUTIL_API void GSMD5Init (MD5_CTX *context)      /* context */
{
...
/* MD5 block update operation. Continues an MD5 message-digest
  ...
  context.
 */
GSUTIL_API void GSMD5Update (
MD5_CTX *context,                                        /* context */
const void *pInputData,                                /* input block */
unsigned int inputLen)                     /* length of input block */
{
  unsigned int i, idx, partLen;
 
  unsigned char *input = (unsigned char *)pInputData;
...
MD5_CTX context;
	...
	GSMD5Init ( &context);
	memset( md5res,0, MD5_LEN );
	GSMD5Update ( &context, pInputData,inputLen );
	GSMD5Final ( md5res, &context );	
}
