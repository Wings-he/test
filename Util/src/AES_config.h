...
#if  (defined(__linux) || defined(linux) || defined(_LINUX)) && !defined(__ARDUINO_X86__)
...
#if defined(__ARDUINO_X86__) || (defined (__linux) || defined (linux) || defined(_LINUX)) || defined (_WIN32)
	#undef PROGMEM
	#ifdef _WIN32
		#define PROGMEM 
